...
Starting in MongoDB 3.6, when updating an array field, you can specify [arrayFilters](https://docs.mongodb.com/manual/reference/command/update/#update-command-arrayfilters) that determine which array elements to update.
