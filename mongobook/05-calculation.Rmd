...
This will return the results in the form of an iterator just like when using the [iterate method](query-data.html#iterating). You can then iterate over the results one by one or in pages:
